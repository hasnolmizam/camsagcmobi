...
}(function ($) 
{
	...
	var defaults = 
	{
		...
		shortDayNames: ["Aha", "Isn", "Sel", "Rab", "Kha", "Jum", "Sab"],
		fullDayNames: ["Ahad", "Isnin", "Selasa", "Rabu", "Khamis", "Jumaat", "Sabtu"],
		shortMonthNames: ["Jan", "Feb", "Mac", "Apr", "Mei", "Jun", "Jul", "Ogo", "Sep", "Okt", "Nov", "Dis"],
		fullMonthNames: ["Januari", "Februari", "Mac", "April", "Mei", "Jun", "Julai", "Ogos", "September", "Oktober", "November", "Disember"],
	...
	DateTimePicker.prototype = {
		...
		_modifyPicker: function()
		{
			...
			if(bDisplaySetButton)
				sDTPickerButtons += "<a class='dtpicker-button dtpicker-buttonSet waves-effect waves-light btn-large deep-purple darken-1'>" + dtPickerObj.settings.setButtonContent + "</a>";
			if(bDisplayClearButton)
				sDTPickerButtons += "<a class='dtpicker-button dtpicker-buttonClear waves-effect waves-light btn-large deep-purple darken-1'>" + dtPickerObj.settings.clearButtonContent + "</a>";
			...
			if(dtPickerObj._compare(dtPickerObj.settings.mode, "date"))
			{
				...
				var sDate = dtPickerObj.settings.formatHumanDate({
                    ...
                    */
					...
					yyyy: sYear,
					day: sDayOfTheWeekFull,
					dayShort: sDayOfTheWeekFull,
					month: sMonthFull,
					monthShort: sMonthShort
				});
				// var sDate = sDayOfTheWeek + ", " + sMonthFull + " " + sDay + ", " + sYear;
				$(dtPickerObj.element).find('.dtpicker-value').html('<b>' + sDate.replace(', ','</b><br>'));
			}
			else if(dtPickerObj._compare(dtPickerObj.settings.mode, "time"))
			{
